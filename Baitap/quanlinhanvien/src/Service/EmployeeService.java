...
public class EmployeeService {
    public Employee inputEmployee(){
        ...
        System.out.println("2.Nhập tên nhân viên:");
        e.name = sc.nextLine();

        System.out.println("3.Nhập ngày tháng năm sinh: ");
        e.birthday = sc.nextLine();

        System.out.println("4.Nhập giới tính: 1-MALE / 2-FEMALE");
        ...
        while (true){
            System.out.println("6.Nhập vào email: ");
            e.email = sc.nextLine();
