...
(1, 'Port of Flowers', 'primis in faucibus orci luctus et ultrices posuere cubilia curae duis faucibus accumsan odio curabitur convallis duis consequat dui', 'porta volutpat quam pede lobortis ligula sit amet eleifend pede libero quis orci nullam molestie nibh in', NULL, 5, 44, '2020-10-17', 'draft'),
(2, 'Bartleby', 'in felis eu sapien cursus vestibulum proin eu mi nulla ac', 'ligula sit amet eleifend pede libero quis orci nullam molestie nibh', NULL, 4, 41, '2020-04-07', 'hidden'),
...
(6, 'It', 'turpis adipiscing lorem vitae mattis nibh ligula nec sem duis aliquam convallis', 'pellentesque viverra pede ac diam cras pellentesque volutpat dui maecenas tristique', NULL, 5, 44, '2021-12-08', 'hidden'),
(7, 'Experts, The', 'eget massa tempor convallis nulla neque libero convallis eget eleifend luctus ultricies eu nibh quisque id justo sit amet sapien dignissim vestibulum vestibulum ante ipsum primis in', 'primis in faucibus orci luctus et ultrices posuere cubilia curae duis faucibus accumsan odio', NULL, 5, 44, '2021-11-11', 'draft');
